...
const [initialParticipantList] = useState<Participant[]>([
  { id: uuidv4(), name: 'Ana', gender: 'female', room: 'A', age: 12, isProblematic: true, problematic_friends: [] },
  { id: uuidv4(), name: 'Bruno', gender: 'male', room: 'A', age: 10, isProblematic: true, problematic_friends: [] },
  { id: uuidv4(), name: 'Carla', gender: 'female', room: 'B', age: 13, isProblematic: true, problematic_friends: []  },
  { id: uuidv4(), name: 'Daniel', gender: 'male', room: 'B', age: 14, isProblematic: true, problematic_friends: []  },
  { id: uuidv4(), name: 'Eva', gender: 'female', room: 'B', age: 15, isProblematic: true, problematic_friends: [] },
  { id: uuidv4(), name: 'Filipe', gender: 'male', room: 'C', age: 14, isProblematic: true, problematic_friends: []  },
  { id: uuidv4(), name: 'Gabriela', gender: 'female', room: 'C', age: 9, isProblematic: true, problematic_friends: []  },
  { id: uuidv4(), name: 'Hugo', gender: 'male', room: 'C', age: 8, isProblematic: true, problematic_friends: []  },
  { id: uuidv4(), name: 'Inês', gender: 'female', room: 'C', age: 11, isProblematic: true, problematic_friends: []  },
]);
